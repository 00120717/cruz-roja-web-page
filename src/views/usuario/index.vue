  ...
  <main class="pb-40">
    ...
    >
      <template slot="actions">
        <custom-button title="Nuevo usuario" color="secondary" to="/usuario/new">
          <template #icon>
            <svg
              class="w-4 h-4 mr-2"
              fill="none"
      ...
      >
        <template slot="items">
          <table-item
            ...
            :item="usuario.id"
            :selected="selectedItems"
            :edit="usuario.rol.tipo !== 'superadmin'"
            :remove="usuario.rol.tipo !== 'superadmin' && usuario.rol.tipo !== 'admin'"
            page="usuario"
          ...
          >
              ...
              <div class="flex items-center">
                <div class="">
                  <div class="text-sm font-medium leading-5 text-gray-900">
                    {{ (`${usuario.firstName} ${usuario.lastName}`)| truncate(20) }}
                  </div>
                </div>
              </div>
            </td>
            ...
            >
              <active-indicator :status="Boolean(usuario.estadoPersona)" />
            </td>
          </table-item>
        </template>
      </table-list>
