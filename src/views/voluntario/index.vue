  ...
  <main class="pb-40">
    ...
    >
      <template slot="actions">
        <custom-button title="Nuevo Voluntario" color="secondary" to="/voluntario/new">
          <template #icon>
            <svg
              class="w-4 h-4 mr-2"
              fill="none"
    ...
    <section>
      <table-list
        ...
        :is-loading="isVoluntarioLoading"
        :filters="filters"
...
export default class VoluntarioPage extends Vue {
  ...
  selectAllCurrent(value: boolean) {
    if (value) {
      this.voluntarios.forEach((item: any) => {
