<template>
  <main class="pb-40">
    <page-heading title="Nuevo rol" back-route="/rol" :breadcrumbs="breadcrumbs" />
    <form-section>
...
export default class NewRolPage extends Vue {
  showPermissionsModal = false;
  newPermissions: Array<number> = [];
  newRolPermiso: Permission[] = [];
  form = {
    nombre: '',
    tipo: '',
    permissionId: [],
  ...
  async onSubmit() {
    ...
    if (isValid) {
      try {
        ...
        await this.createRol({ rol: this.form, vm: this });
